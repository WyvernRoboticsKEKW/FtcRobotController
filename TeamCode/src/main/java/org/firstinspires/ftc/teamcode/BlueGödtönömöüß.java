...
@Autonomous(name="Blue Gödtönömöüß")
public class BlueGödtönömöüß extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        control.voltageRunMecanum(-1,0,0,150);
        ...
        sleep(500);
        control.voltageRunMecanum(0,-1,0,250);
