...
{
    Scalar Cyan = new Scalar(150,0 ,0 );
    ...
    public Mat processFrame(Mat input)
    {
        ...
        try
        {
            ...
            // Draw Borders
            Imgproc.rectangle(output, new Rect(borderLeftX, borderTopY, CAMERA_WIDTH - borderRightX - borderLeftX, CAMERA_HEIGHT - borderBottomY - borderTopY), Cyan, 2);
            // Display Data
